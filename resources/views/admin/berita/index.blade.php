...
@section('content')
    ...
    <main class="bg-white dark:bg-blue-800 p-5 m-3 border-gray-200 dark:border-gray-700 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-blue-800">
                                ...
                                @forelse($articles as $article)
                                    <tr class="hover:bg-blue-100 dark:hover:bg-blue-700">
                                        ...
                                        <td class="p-4 space-x-2 whitespace-nowrap text-end">
                                            <a href="{{ route('admin.berita.edit', $article['id']) }}" class="inline-flex items-center px-3 py-2  font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                            ...
                                            @include('admin.berita.delete', ['article' => $article])
        ...
        @if(!request()->get('show') == 'all' and !request()->get('query'))
            {{ $articles->onEachSide(0)->links('components.admin.pagination', ['show_all' => route('admin.berita') . '?show=all']) }}
        @endif
