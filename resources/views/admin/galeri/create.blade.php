                ...
                <form action="#">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            ...
                            <label class="block mb-2  font-medium text-black-900 dark:text-white" for="image">Upload Image</label>
                        ...
                        <div class="col-span-6">
                            <label for="description" class="block mb-2  font-medium text-black-900 dark:text-white">Biography</label>
