...
@section('content')
    ...
    <main class="bg-white dark:bg-gray-800 p-5 m-3 border-gray-200 dark:border-gray-700 rounded-lg shadow-sm">
        ...
        <div class="w-full mb-3">
            ...
            <div class="flex gap-3">
                ...
                <div
                    ...
                    <form class="flex items-center max-w-sm mx-auto" action="{{ route('admin.layanan.index') }}"
                          method="GET">
                            ...
                            @forelse($layanans as $layanan)
                                ...
                                <tr class="hover:bg-blue-100 dark:hover:bg-blue-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap text-end">
                                        ...
                                        <button type="button" data-modal-target="edit-modal-{{ $layanan->id }}"
                                                data-modal-toggle="edit-modal-{{ $layanan->id }}"
                                        ...
                                        <button type="button" data-modal-target="delete-modal-{{ $layanan->id }}"
                                                data-modal-toggle="delete-modal-{{ $layanan->id }}"
                                        ...
                                        @include('admin.layanan.edit', ['layanan' => $layanan])
                                        @include('admin.layanan.delete', ['layanan' => $layanan])
        ...
        @if(!request()->get('show') == 'all' and !request()->get('query'))
            {{ $layanans->onEachSide(0)->links('components.admin.pagination', ['show_all' => route('admin.layanan.index') . '?show=all']) }}
        @endif
