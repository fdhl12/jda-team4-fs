...
=======
                ...
                @endif
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Memunculkan <span class="font-semibold text-gray-900 dark:text-white">1-10</span> of <span class="font-semibold text-gray-900 dark:text-white">{{$users->count()}}</span></span>
            </div>
            <div class="flex items-center space-x-3">
                @if ($users->previousPageUrl())
