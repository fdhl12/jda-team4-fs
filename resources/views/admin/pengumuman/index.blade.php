...
@section('content')
    ...
    <main class="bg-white dark:bg-blue-800 p-5 m-3 border-gray-200 dark:border-gray-700 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-blue-800">
        ...
        <div class="w-full mb-3">
            ...
            <div class="flex gap-3">
                ...
                <div class="flex items-center mr-auto space-x-2 sm:space-x-3">
                    <a href="{{ route('admin.pengumuman.create') }}" class="inline-flex items-center justify-center px-3 py-2  font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                ...
                <div class="flex divide-x divide-gray-100 dark:divide-gray-700">
                    <form class="flex items-center max-w-sm mx-auto" action="{{ route('admin.pengumuman') }}" method="GET">
                            ...
                            @forelse($announcements as $announcement)
                                <tr class="hover:bg-blue-100 dark:hover:bg-blue-700">
                                    <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-black-500 truncate xl:max-w-xs dark:text-black-400">
                                        <a target="_blank" class="hover:text-blue-600" href="{{ url('pengumuman/'.$announcement['slug']) }}">
                                            {{ $announcement['title'] }}
                                        </a>
                                    </td>
                                    <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-black-500 truncate xl:max-w-xs dark:text-black-400">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap text-end">
                                        <a href="{{ route('admin.pengumuman.edit', $announcement['id']) }}" class="inline-flex items-center px-3 py-2  font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                                            Ubah
                                        </a>
                                        <button type="button" data-modal-toggle="delete-modal-{{ $announcement['id'] }}" data-modal-target="delete-modal-{{ $announcement['id'] }}" class="inline-flex items-center px-3 py-2  font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900 delete-button" data-id="{{ $announcement['id'] }}">
                                            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                            Hapus
                                        </button>

                                        @include('admin.pengumuman.delete', ['announcement' => $announcement])
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-3">
                                        @if(request()->get('query'))
                                            ...
                                            <a href="{{ route('admin.pengumuman') }}" class="underline">Kembali</a>
                                        @else
        ...
        @if(!request()->get('show') == 'all' and !request()->get('query'))
            {{ $announcements->onEachSide(0)->links('components.admin.pagination', ['show_all' => route('admin.pengumuman') . '?show=all']) }}
        @endif
