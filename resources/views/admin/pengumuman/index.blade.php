        ...
        <div class="w-full mb-3">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center mr-auto space-x-2 sm:space-x-3">
                    <a href="{{ route('admin.pengumuman.create') }}" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                ...
                <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden shadow">
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tr>
                                <th scope="col" class="p-4 text-xs font-medium text-left whitespace-nowrap text-gray-500 uppercase dark:text-gray-400 w-80">
                                    Title
                                </th>
                                <th scope="col" class="p-4 text-xs font-medium text-left whitespace-nowrap text-gray-500 uppercase dark:text-gray-400 w-10">
                                    Created At
                                </th>
                                <th scope="col" class="p-4 text-xs font-medium text-end whitespace-nowrap text-gray-500 uppercase dark:text-gray-400 w-10">
                                    Actions
                                </th>
                            </tr>
                            </thead>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap text-end">
                                    <a href="{{ route('admin.pengumuman.edit', 1) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                        <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                                        Edit
                                    </a>
                                    <button type="button" data-modal-toggle="delete-modal" data-modal-target="delete-modal" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
