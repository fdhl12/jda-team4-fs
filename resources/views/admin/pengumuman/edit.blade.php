            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 flex align-middle items-center space-x-4">
                    ...
                    @if($announcement->image)
                        <div>
                            <img class="h-16" src="{{ $announcement->image }}" alt="Gambar">
                        </div>
                    @endif
                </div>
                <div class="col-span-6">
