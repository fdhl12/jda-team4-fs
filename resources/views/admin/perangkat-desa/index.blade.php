...
@section('content')
    ...
    <main class="bg-white dark:bg-gray-800 p-5 m-3 border-gray-200 dark:border-gray-700 rounded-lg shadow-sm">
                ...
                <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden shadow">
                        <table id="table" class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tr>
                                <th scope="col" class="p-4 font-semibold text-left whitespace-nowrap text-black-500 uppercase dark:text-black-400 w-60">
                                    Nama
                                </th>
                                <th scope="col" class="p-4 font-semibold text-left whitespace-nowrap text-black-500 uppercase dark:text-black-400 w-20">
                                    Jabatan
                                </th>
        ...
        @if(!request()->get('show') == 'all' and !request()->get('query'))
            {{ $perangkatdesas->onEachSide(0)->links('components.admin.pagination', ['show_all' => route('admin.perangkat-desa.index') . '?show=all']) }}
        @endif
