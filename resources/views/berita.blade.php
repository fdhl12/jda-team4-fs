            ...
            <div class="container mx-auto px-4">
                ...
                <div id="default-carousel" class="relative w-full col-span-1 md:col-span-2" data-carousel="slide">
                    ...
                    <h2 class="text-5xl font-bold text-blue-950 text-center mb-4" data-aos="zoom-in"
                        data-aos-duration="500">Berita Terkini</h2>
                    ...
                    <p class="text-3xl font-medium text-orange-500 text-center mb-4" data-aos="zoom-in"
                       data-aos-duration="500">Berita Seputar
                        {{ $pengaturan['name'] }}</p>
                    <!-- Carousel wrapper -->
                    <div class="relative h-[35rem] overflow-hidden rounded-lg" data-aos="zoom-in"
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <figure class="relative w-full h-full transition-all duration-300 cursor-pointer group">
                                    <a href="{{ route('show.berita', $news->slug) }}">
                                        ...
                                        <div
                                            class="absolute inset-0 bg-gradient-to-r from-black via-transparent to-black opacity-50 rounded-lg"></div>
                                        <div
                                            class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black opacity-50 rounded-lg"></div>
                                    </a>
                    ...
                    <div class="absolute inset-0 flex items-center justify-between z-10">
                        <button type="button"
                                class="flex items-center justify-center w-10 h-10 rounded-full bg-white/30 hover:bg-white/50 focus:ring-4 focus:ring-white focus:outline-none ml-4"
                                data-carousel-prev>
                        ...
                        <button type="button"
                                class="flex items-center justify-center w-10 h-10 rounded-full bg-white/30 hover:bg-white/50 focus:ring-4 focus:ring-white focus:outline-none mr-4"
                                data-carousel-next>
                            <svg class="w-4 h-4 text-white rtl:rotate-180" aria-hidden="true"
                                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
        ...
        <section id="berita" class="bg-white border-b py-8 bg-banner-1">
            <div class="container mx-auto px-4 md:px-4 lg:px-8 xl:px-12 flex flex-wrap justify-center pt-4 pb-12">
                ...
                <div class="w-full text-center mb-4">
                    <p class="text-3xl font-medium text-orange-500" data-aos="zoom-in" data-aos-duration="500">Berita
                        Seputar
                        {{ $pengaturan['name'] }}</p>
                </div>

                <!-- Include the search form component with a route parameter -->
                @include('components.search', ['route' => route('berita','#berita'), 'type' => 'berita'])

                @if($newss->isEmpty())
                    <div class="w-full text-center">
                        <p class="text-xl text-gray-600">Tidak ada berita yang ditemukan.</p>
                    </div>
                @else
