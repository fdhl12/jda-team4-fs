    ...
    <div class="pt-24">
        <section class="bg-white border-b py-12 text-center">
            <div class="container mx-auto px-8"> <!-- Increased px for more space -->
                ...
                <p class="text-3xl font-medium text-blue-900 mb-8">Kontak Layanan Sekitar {{ $pengaturan['name'] }}</p> <!-- Larger text size -->

                <article>

                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-lg text-left rtl:text-right text-blue-500 dark:text-blue-400">
                            <thead class="text-lg text-blue-700 uppercase bg-blue-50 dark:bg-blue-700 dark:text-blue-400">
                            <tr>
                            ...
                            <tbody>
                                @forelse($layanans as $layanan)
                                    <tr class="bg-white border-b dark:bg-blue-800 dark:border-blue-700">
                                        ...
                                        <th scope="row" class="px-6 py-4 font-bold text-orange-400 whitespace-nowrap dark:text-white">
                                            {{ $layanan->telepon }}
                                        </td>
                                        <th scope="row" class="px-6 py-4 font-medium text-blue-900 whitespace-nowrap dark:text-white">
                                            {{ $layanan->buka }}
