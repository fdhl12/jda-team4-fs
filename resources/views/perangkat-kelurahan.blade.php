    ...
    <div class="mt-24 mb-auto  text-black">
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow hover:shadow-lg transition-shadow duration-300 ease-in-out overflow-hidden flex flex-col">
                    <a href="{{route('perangkat-kelurahan.show', $perangkat->id)}}" class="block flex-grow">
                        <div class="aspect-w-1 aspect-h-1 w-full">
                            <img class="object-cover w-full h-full transition-transform duration-300 ease-in-out hover:scale-105" src="{{asset('storage/'.$perangkat->image)}}" alt="Foto {{$perangkat->name}}">
                        </div>
                    </a>
                    <div class="p-4 flex flex-col items-center">
                        <h5 class="text-2xl font-bold tracking-tight text-blue-950 truncate text-center">
                            {{$perangkat->name}}
                        </h5>
                        <p class="text-xl font-medium text-gray-700 mt-2 text-center">
