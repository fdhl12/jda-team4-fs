<nav id="header" class="fixed w-full z-50 top-0 bg-white">
            ...
            <ul class="list-reset lg:flex  justify-end flex-1 xl:items-center">
                ...
                <li class="mr-3 dropdown relative">
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar-1"
                            class="flex items-center py-6 px-6 text-lg lg:text-2xl font-bold no-underline hover:text-blue-900 hover:border-b-4 hover:border-blue-900 {{ request()->is('lembaga-kelurahan*') || request()->is('perangkat-kelurahan*') || request()->is('strucktur*') ? 'text-blue-900 border-b-4 border-blue-900' : '' }}">
                ...
                <li class="mr-3 dropdown relative">
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                            class="flex items-center py-6 px-6 text-lg lg:text-2xl font-bold no-underline hover:text-blue-900 hover:border-b-4 hover:border-blue-900 {{ request()->is('tentang*') || request()->is('visimisi*') || request()->is('sejarah*') || request()->is('geografi*') || request()->is('demografi*') ? 'text-blue-900 border-b-4 border-blue-900' : '' }}">
                        <span>Profile</span>
                        <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                             fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="py-3 text-lg" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                                <a href="{{ route('visimisi') }}"
                                   class="block px-4 py-3 lg:text-lg text-gray-700 dark:text-gray-300 font-bold hover:bg-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">Visi & Misi</a>
                            </li>
                            <li>
                ...
                <li class="mr-3 dropdown relative">
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar-2"
                            class="flex items-center py-6 px-6 text-lg lg:text-2xl font-bold no-underline hover:text-blue-900 hover:border-b-4 hover:border-blue-900 {{ request()->is('berita*') || request()->is('pengumuman*') || request()->is('galeri*') ? 'text-blue-900 border-b-4 border-blue-900' : '' }}">
                        <span>Informasi</span>
                        <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                             fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li class="mr-3">
                    <a class="flex items-center py-6 px-6 text-lg lg:text-2xl font-bold no-underline hover:text-blue-900 hover:border-b-4 hover:border-blue-900 {{ request()->is('layanan*') ? 'text-blue-900 border-b-4 border-blue-900' : '' }}" href="{{ route('layanan') }}">Layanan</a>
                </li>
            </ul>
        </div>
    </div>
