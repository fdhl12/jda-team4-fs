...
<html lang="en">
  <head>
    ...
    <style>
        .gradient {
    /* Gabungkan gambar latar belakang dan gradien */
    background: 
        linear-gradient(90deg, rgba(0, 67, 137, 0.5), rgba(64, 171, 227, 1)), /* Gradien */
        url('images/foto-1.jpeg') center/cover; /* Foto dengan posisi dan ukuran */
    background-size:170%; 
    }
  ...
  <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
    <div class="pl-4 flex items-center">
      <a class="toggleColour text-white no-underline hover:no-underline font-bold text-3xl lg:text-4xl" href="#">
    ...
    <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
      <ul class="list-reset lg:flex justify-end flex-1 items-center">
        <li class="mr-3">
          <a class="inline-block py-6 px-6 text-lg lg:text-xl font-bold no-underline hover:bg-gray-200 hover:text-gray-800" href="#">Home</a>
        </li>
        <li class="mr-3 dropdown relative">
          <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex items-center py-6 px-6 text-lg lg:text-xl font-bold no-underline hover:bg-gray-200 hover:text-gray-800">
            <span>Profile</span>
          ...
          <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Tentang</a>
              </li>
              <li>
              ...
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Geografis</a>
              </li>
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Demografis</a>
              </li>
            </ul>
          </div>
        </li>
        <li class="mr-3">
          <a class="inline-block py-6 px-6 text-lg lg:text-xl font-bold no-underline hover:bg-gray-200 hover:text-gray-800" href="#">Berita</a>
        </li>
        <li class="mr-3">
          <a class="inline-block py-6 px-6 text-lg lg:text-xl font-bold no-underline hover:bg-gray-200 hover:text-gray-800" href="#">Galeri</a>
        </li>
        <li class="mr-3">
          <a class="inline-block py-6 px-6 text-lg lg:text-xl font-bold no-underline hover:bg-gray-200 hover:text-gray-800" href="#">Kontak</a>
        </li>
      </ul>
    </div>
  </div>
      ...
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 py-4 justify-center items-start text-center md:text-left">
          ...
          <div class="flex justify-center md:justify-start space-x-6">
            <a href="https://www.instagram.com" target="_blank" class="text-gray-500 hover:text-gray-700 transform transition-transform duration-300 ease-in-out hover:scale-110 hover:rotate-6 bg-white rounded-full p-5 shadow-lg hover:shadow-xl">
              <i class="fab fa-instagram text-2xl"></i>
            </a>
            <a href="https://www.twitter.com" target="_blank" class="text-gray-500 hover:text-gray-700 transform transition-transform duration-300 ease-in-out hover:scale-110 hover:rotate-6 bg-white rounded-full p-5 shadow-lg hover:shadow-xl">
              <i class="fab fa-twitter text-2xl"></i>
            </a>
            <a href="https://www.tiktok.com" target="_blank" class="text-gray-500 hover:text-gray-700 transform transition-transform duration-300 ease-in-out hover:scale-110 hover:rotate-6 bg-white rounded-full p-5 shadow-lg hover:shadow-xl">
