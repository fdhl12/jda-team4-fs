...
<html lang="en">
  <head>
    ...
    background-size: 100%; /* Atur ukuran gambar untuk menutupi seluruh area */
}
 /* CSS untuk submenu */
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
          <a class="toggleColour text-white no-underline hover:no-underline font-bold text-3xl lg:text-4xl " href="#">
            ...
            <img src="{{ url('images/logo.png') }}" alt="Example Image" class="w-20 h-20">
          </a>
        </div>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-6 px-6 text-lg lg:text-xl text-black font-bold no-underline hover:bg-gray-200 hover:text-gray-800" href="#">Home</a>
            </li>
            <li class="mr-3 dropdown relative">
              <a class="inline-block text-lg lg:text-xl text-black no-underline hover:bg-gray-200 hover:text-gray-800 hover:text-underline py-6 px-6 relative" href="#">Profil</a>
              <ul class="submenu">
                <li><a href="#" class="text-lg lg:text-xl">Tentang</a></li>
                <li><a href="#" class="text-lg lg:text-xl">Visi Misi</a></li>
                <li><a href="#" class="text-lg lg:text-xl">Sejarah</a></li>
                <li><a href="#" class="text-lg lg:text-xl">Geografis</a></li>
                <li><a href="#" class="text-lg lg:text-xl">Demografis</a></li>
              </ul>
            </li>
            <li class="mr-3">
              <a class="inline-block text-lg lg:text-xl text-black no-underline hover:bg-gray-200 hover:text-gray-800 hover:text-underline py-6 px-6" href="#">Berita</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-lg lg:text-xl text-black no-underline hover:bg-gray-200 hover:text-gray-800 hover:text-underline py-6 px-6" href="#">Galeri</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-lg lg:text-xl text-black no-underline hover:bg-gray-200 hover:text-gray-800 hover:text-underline py-6 px-6" href="#">Kontak</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <!-- Left Col -->
          <div class="flex flex-col w-full md:w-2/5 py-2 justify-center items-start text-center md:text-left">
          ...
          <!-- Right Col -->
        <div class="w-full md:w-3/5 py-10 text-center md:flex md:justify-end">
          <img src="{{ url('images/logo.png') }}" alt="Example Image" class="w-full md:w-2/4">
        </div>
      </div>
